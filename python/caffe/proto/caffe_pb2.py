...
_CLASSLABELPARAMETER_LABEL_TYPE = _descriptor.EnumDescriptor(
  name='Label_type',
  full_name='caffe.ClassLabelParameter.Label_type',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SEGMENTATION', index=1, number=1,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_CLASSLABELPARAMETER_LABEL_TYPE)
...
_CONVOLUTIONPARAMETER_OPTIMIZATION = _descriptor.EnumDescriptor(
  name='Optimization',
  full_name='caffe.ConvolutionParameter.Optimization',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='IM2COL', index=0, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='KN2ROW', index=1, number=1,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_CONVOLUTIONPARAMETER_OPTIMIZATION)
...
_NONMAXIMUMSUPPRESSIONPARAMETER_NMS_TYPE = _descriptor.EnumDescriptor(
  name='NMS_Type',
  full_name='caffe.NonMaximumSuppressionParameter.NMS_Type',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='Gaussian', index=2, number=2,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_NONMAXIMUMSUPPRESSIONPARAMETER_NMS_TYPE)
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='random_shuffle_param', full_name='caffe.LayerParameter.random_shuffle_param', index=66,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='correlation_param', full_name='caffe.LayerParameter.correlation_param', index=67,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dynamic_routine_param', full_name='caffe.LayerParameter.dynamic_routine_param', index=68,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mm_param', full_name='caffe.LayerParameter.mm_param', index=69,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='deform_sample_param', full_name='caffe.LayerParameter.deform_sample_param', index=70,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='class_label_param', full_name='caffe.LayerParameter.class_label_param', index=71,
...
_CLASSLABELPARAMETER = _descriptor.Descriptor(
  name='ClassLabelParameter',
  full_name='caffe.ClassLabelParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='num_classes', full_name='caffe.ClassLabelParameter.num_classes', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='label_type', full_name='caffe.ClassLabelParameter.label_type', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='variance', full_name='caffe.ClassLabelParameter.variance', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(1),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[],
  enum_types=[
    _CLASSLABELPARAMETER_LABEL_TYPE,
  ],
  options=None,
  is_extendable=False,
  syntax='proto2',
...
_DEFORMSAMPLEPARAMETER = _descriptor.Descriptor(
  name='DeformSampleParameter',
  full_name='caffe.DeformSampleParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='num_samples_per_loc', full_name='caffe.DeformSampleParameter.num_samples_per_loc', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MMPARAMETER = _descriptor.Descriptor(
  name='MMParameter',
  full_name='caffe.MMParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='num_output', full_name='caffe.MMParameter.num_output', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='normalize', full_name='caffe.MMParameter.normalize', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='eps', full_name='caffe.MMParameter.eps', index=2,
      number=3, type=2, cpp_type=6, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='weight_filler', full_name='caffe.MMParameter.weight_filler', index=3,
...
_DYNAMICROUTINEPARAMETER = _descriptor.Descriptor(
  name='DynamicRoutineParameter',
  full_name='caffe.DynamicRoutineParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='iterations', full_name='caffe.DynamicRoutineParameter.iterations', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CORRELATIONPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='kernel_size', full_name='caffe.CorrelationParameter.kernel_size', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='displacement', full_name='caffe.CorrelationParameter.displacement', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='dilation', full_name='caffe.CorrelationParameter.dilation', index=2,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RANDOMSHUFFLEPARAMETER = _descriptor.Descriptor(
  name='RandomShuffleParameter',
  full_name='caffe.RandomShuffleParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='axis', full_name='caffe.RandomShuffleParameter.axis', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOSSPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='focal_loss', full_name='caffe.LossParameter.focal_loss', index=1,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='focal_loss_param', full_name='caffe.LossParameter.focal_loss_param', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='normalization', full_name='caffe.LossParameter.normalization', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='normalize', full_name='caffe.LossParameter.normalize', index=4,
      number=2, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FOCALLOSSPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='gamma', full_name='caffe.FocalLossParameter.gamma', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='compensate_imbalance', full_name='caffe.FocalLossParameter.compensate_imbalance', index=1,
      number=2, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='background_label_id', full_name='caffe.FocalLossParameter.background_label_id', index=3,
      number=4, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CONVOLUTIONPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='optimization', full_name='caffe.ConvolutionParameter.optimization', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='using_approximate', full_name='caffe.ConvolutionParameter.using_approximate', index=17,
  ...
  enum_types=[
    ...
    _CONVOLUTIONPARAMETER_OPTIMIZATION,
  ],
  options=None,
  is_extendable=False,
  syntax='proto2',
...
_NONMAXIMUMSUPPRESSIONPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='type', full_name='caffe.NonMaximumSuppressionParameter.type', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='variance', full_name='caffe.NonMaximumSuppressionParameter.variance', index=4,
      number=5, type=2, cpp_type=6, label=1,
  ...
  nested_types=[],
  enum_types=[
    _NONMAXIMUMSUPPRESSIONPARAMETER_NMS_TYPE,
  ],
  options=None,
  is_extendable=False,
  syntax='proto2',
...
_MULTIBOXLOSSPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gamma', full_name='caffe.MultiBoxLossParameter.gamma', index=22,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='correct_class_imbalance', full_name='caffe.MultiBoxLossParameter.correct_class_imbalance', index=23,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_condition', full_name='caffe.MultiBoxLossParameter.is_condition', index=24,
...
_SOFTMAXPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='condition', full_name='caffe.SoftmaxParameter.condition', index=2,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['random_shuffle_param'].message_type = _RANDOMSHUFFLEPARAMETER
_LAYERPARAMETER.fields_by_name['correlation_param'].message_type = _CORRELATIONPARAMETER
_LAYERPARAMETER.fields_by_name['dynamic_routine_param'].message_type = _DYNAMICROUTINEPARAMETER
_LAYERPARAMETER.fields_by_name['mm_param'].message_type = _MMPARAMETER
_LAYERPARAMETER.fields_by_name['deform_sample_param'].message_type = _DEFORMSAMPLEPARAMETER
_LAYERPARAMETER.fields_by_name['class_label_param'].message_type = _CLASSLABELPARAMETER
_CLASSLABELPARAMETER.fields_by_name['label_type'].enum_type = _CLASSLABELPARAMETER_LABEL_TYPE
_CLASSLABELPARAMETER_LABEL_TYPE.containing_type = _CLASSLABELPARAMETER
_MMPARAMETER.fields_by_name['weight_filler'].message_type = _FILLERPARAMETER
...
_LOSSPARAMETER.fields_by_name['focal_loss_param'].message_type = _FOCALLOSSPARAMETER
...
_CONVOLUTIONPARAMETER.fields_by_name['optimization'].enum_type = _CONVOLUTIONPARAMETER_OPTIMIZATION
_CONVOLUTIONPARAMETER_ENGINE.containing_type = _CONVOLUTIONPARAMETER
_CONVOLUTIONPARAMETER_OPTIMIZATION.containing_type = _CONVOLUTIONPARAMETER
...
_NONMAXIMUMSUPPRESSIONPARAMETER.fields_by_name['type'].enum_type = _NONMAXIMUMSUPPRESSIONPARAMETER_NMS_TYPE
_NONMAXIMUMSUPPRESSIONPARAMETER_NMS_TYPE.containing_type = _NONMAXIMUMSUPPRESSIONPARAMETER
...
DESCRIPTOR.message_types_by_name['ClassLabelParameter'] = _CLASSLABELPARAMETER
DESCRIPTOR.message_types_by_name['DeformSampleParameter'] = _DEFORMSAMPLEPARAMETER
DESCRIPTOR.message_types_by_name['MMParameter'] = _MMPARAMETER
DESCRIPTOR.message_types_by_name['DynamicRoutineParameter'] = _DYNAMICROUTINEPARAMETER
DESCRIPTOR.message_types_by_name['CorrelationParameter'] = _CORRELATIONPARAMETER
DESCRIPTOR.message_types_by_name['RandomShuffleParameter'] = _RANDOMSHUFFLEPARAMETER
...
ClassLabelParameter = _reflection.GeneratedProtocolMessageType('ClassLabelParameter', (_message.Message,), dict(
  DESCRIPTOR = _CLASSLABELPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.ClassLabelParameter)
  ))
_sym_db.RegisterMessage(ClassLabelParameter)

DeformSampleParameter = _reflection.GeneratedProtocolMessageType('DeformSampleParameter', (_message.Message,), dict(
  DESCRIPTOR = _DEFORMSAMPLEPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.DeformSampleParameter)
  ))
_sym_db.RegisterMessage(DeformSampleParameter)

MMParameter = _reflection.GeneratedProtocolMessageType('MMParameter', (_message.Message,), dict(
  DESCRIPTOR = _MMPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.MMParameter)
  ))
_sym_db.RegisterMessage(MMParameter)

DynamicRoutineParameter = _reflection.GeneratedProtocolMessageType('DynamicRoutineParameter', (_message.Message,), dict(
  DESCRIPTOR = _DYNAMICROUTINEPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.DynamicRoutineParameter)
  ))
_sym_db.RegisterMessage(DynamicRoutineParameter)
...
RandomShuffleParameter = _reflection.GeneratedProtocolMessageType('RandomShuffleParameter', (_message.Message,), dict(
  DESCRIPTOR = _RANDOMSHUFFLEPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.RandomShuffleParameter)
  ))
_sym_db.RegisterMessage(RandomShuffleParameter)
